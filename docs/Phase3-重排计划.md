...
> 说明：上述 epic 的现有子任务 issue（如 #106–#109 属 #105、#111–#114 属 #110、#116–#119 属 #115、#121–#123 属 #120、#125–#128 属 #24、#130–#133 属 #17、#135–#138 属 #1）目前按 gogpu API 撰写，需按本计划重写（已在各 epic 下评论标记，正文见第 3 节）。
...
- 子任务 issue（#106–#138 等）正文仍按 gogpu 撰写，待本计划评审通过后，按第 3 节重写其子任务（建议逐 epic 评论 + 必要时重建子 issue）。
